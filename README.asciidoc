== undertow-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The undertow-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.undertow.forge</groupId>
   <artifactId>undertow-addon</artifactId>
